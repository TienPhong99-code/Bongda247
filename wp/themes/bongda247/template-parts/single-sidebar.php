        ...
        <li>
          <a href="<?php echo esc_url(get_permalink()); ?>" class="group block">
            <?php if (has_post_thumbnail()) : ?>
              <div class="rounded-lg overflow-hidden border border-card mb-2 aspect-video">
            ...
            <?php endif; ?>
            <h3 class="font-oswald text-base font-bold leading-snug line-clamp-2 group-hover:text-brand transition-colors"><?php the_title(); ?></h3>
